...
function load_rating_data() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 5; i >= 1; i--) {
                var star_review_count = data[i + '_star_review'];
                var progress_percentage = (data.total_review > 0) ? (star_review_count / data.total_review * 100) : 0;
                $('#total_' + i + '_star_review').text(star_review_count);
                $('#' + i + '_star_progress').css('width', progress_percentage + '%').attr('aria-valuenow', progress_percentage);
            }
            ...
            if (data.review_data.length > 0) {
                for (var count = 0; count < data.review_data.length; count++) {
                    ...
                    html += '<div class="card">';
                    html += '<div class="card-header"><b>' + data.review_data[count].user_name + ' reviewed ' + data.review_data[count].product_name + '</b></div>';
                ...
                html = '<div class="card"><div class="card-body">No Reviews</div></div>';
            }
